...
const RightSidebar = ({selectedUser}) => {
  return selectedUser &&  (
    <div className={`bg-[#8185B2]/10 text-white relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}> 
        ...
        <button className='absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-red-500 text-white text-sm px-20 py-2 rounded-full cursor-pointer bg-gradient-to-r from-purple-900 to-violet-900 border-none font-light'>
            Logout
        </button>
