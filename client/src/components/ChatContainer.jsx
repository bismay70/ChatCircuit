  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        <p  className='flex-1 text-lg text-white flex items-center gap-2'>Martin jihbnson
      ...
      <div className='absolute bottom-0 left-0 right-0  p-3  flex items-center gap-3'>
        <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full"> 
          <input type="text" placeholder="Send a msg" className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-400'/>
